...
import  CubismViewMatrix = require('../live2D/Framework/src/math/cubismviewmatrix');
...
export class LAppView {
  ...
  _deviceToScreen: CubismMatrix44.CubismMatrix44; // デバイスからスクリーンへの行列
  _viewMatrix: CubismViewMatrix.CubismViewMatrix; // viewMatrix
